...
<aside id="sidebar-wrapper">
    ...
    <a href="inicio"> <img alt="image" src="vistas/assets/img/logo.png" class="header-logo" /> <span
        class="logo-name">CM System</span>
    </a>
    </div>
    ...
    <li class="dropdown">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i class="fas fa-shipping-fast"></i><span>Ventas</span></a>
        <ul class="dropdown-menu">
    ...
    <li class="dropdown">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i class="fab fa-creative-commons-nc"></i><span>Pagos</span></a>
        <ul class="dropdown-menu">
        <li><a class="nav-link" href="pago-prov"> Pago a proveedores</a></li>
        <li><a class="nav-link" href="pago-emp"> Pago a empleados</a></li>
        </ul>
    </li>
    <!-- <li class="menu-header">Comunicaciòn</li>
    <li class="dropdown">
        <a href="correo" class="menu-toggle nav-link has-dropdown"><i class="fas fa-envelope-open-text"></i><span>Correo</span></a>
        <ul class="dropdown-menu">
        <li><a class="nav-link" href="inbox">Buzón de entrada</a></li>
        <li><a class="nav-link" href="componer">Escribir</a></li>
        </ul>
    </li> -->
